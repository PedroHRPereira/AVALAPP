...
import com.example.pedro.avalapp.Jogos.Jogo5;
...
public class Avaliacao5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avaliacao5);
    ...
    private void eventoClick() {
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Avaliacao5.this, Jogo5.class);
                startActivity(i);
                finish();
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ratingBar1.getRating() == 0 || ratingBar2.getRating() == 0 ||
                    ...
                    usuario.setNota5("" + nota);

                    // Referencia ao banco de dados onde será salva a nota
                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
                    databaseReference.child("Usuario").child(user.getUid()).child("nota5").setValue(usuario.getNota5());

                    Intent i = new Intent(Avaliacao5.this, Perfil.class);
                    startActivity(i);
                    finish();
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Avaliacao5.this, msg, Toast.LENGTH_SHORT).show();
    }
