...
import com.example.pedro.avalapp.Jogos.Jogo3;
...
public class Avaliacao3 extends AppCompatActivity {
    ...
    private void eventoClick() {
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Avaliacao3.this, Jogo3.class);
                startActivity(i);
                finish();
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Avaliacao3.this, msg, Toast.LENGTH_SHORT).show();
    }
