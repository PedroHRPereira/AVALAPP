...
import com.example.pedro.avalapp.Jogos.Jogo;
...
public class Avaliacao extends AppCompatActivity {
    ...
    private void eventoClick() {
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Avaliacao.this, Jogo.class);
                startActivity(i);
                finish();
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ratingBar1.getRating() == 0 || ratingBar2.getRating() == 0 ||
                    ...
                    // Método para geração da nota do jogo e inserção ao banco de dados
                    double peso = 1.5;
                    ...
                    databaseReference.child("Usuario").child(user.getUid()).child("nota1").setValue(usuario.getNota1());

                    Intent i = new Intent(Avaliacao.this, Perfil.class);
                    startActivity(i);
                    finish();
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Avaliacao.this, msg, Toast.LENGTH_SHORT).show();
    }
