package com.example.pedro.avalapp.Avaliacao;
...
import com.example.pedro.avalapp.Jogos.Jogo2;
...
public class Avaliacao2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avaliacao2);
    ...
    private void eventoClick() {
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Avaliacao2.this, Jogo2.class);
                startActivity(i);
                finish();
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ratingBar1.getRating() == 0 || ratingBar2.getRating() == 0 ||
                    ...
                    usuario.setNota2("" + nota);

                    // Referencia ao banco de dados onde será salva a nota
                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
                    databaseReference.child("Usuario").child(user.getUid()).child("nota2").setValue(usuario.getNota2());

                    Intent i = new Intent(Avaliacao2.this, Perfil.class);
                    startActivity(i);
                    finish();
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Avaliacao2.this, msg, Toast.LENGTH_SHORT).show();
    }
