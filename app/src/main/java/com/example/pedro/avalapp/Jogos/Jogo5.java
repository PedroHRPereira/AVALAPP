...
import com.example.pedro.avalapp.Avaliacao.Avaliacao4;
import com.example.pedro.avalapp.Avaliacao.Avaliacao5;
...
public class Jogo5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo5);
    ...
    private void eventoClick() {
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Jogo5.this, Perfil.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Jogo5.this, msg, Toast.LENGTH_LONG).show();
    }
