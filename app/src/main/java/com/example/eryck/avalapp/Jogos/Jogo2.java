...
import com.example.eryck.avalapp.Avaliacao.Avaliacao2;
...
public class Jogo2 extends AppCompatActivity {
    ...
    private void eventoClick() {
        btnClassificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Jogo2.this, Avaliacao2.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Jogo2.this, msg, Toast.LENGTH_LONG).show();
    }
