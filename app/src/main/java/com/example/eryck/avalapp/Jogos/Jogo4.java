...
import com.example.eryck.avalapp.Avaliacao.Avaliacao3;
import com.example.eryck.avalapp.Avaliacao.Avaliacao4;
...
public class Jogo4 extends AppCompatActivity {
            ...
            databaseReference.child("Usuario").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (Usuario u : listaUsuarios) {
                        soma += Double.parseDouble(u.getNota4());
                    }
    ...
    private void eventoClick() {
        btnClassificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Jogo4.this, Avaliacao4.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void alert(String msg) {
        ...
        Toast.makeText(Jogo4.this, msg, Toast.LENGTH_LONG).show();
    }
